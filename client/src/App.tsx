      ...
      if (match) {
        ...
        return (
          <button
            ...
            className="inline-flex items-center gap-1 mx-1 px-2 py-0.5 rounded-md bg-red-500/20 hover:bg-red-500/40 text-red-400 font-bold text-xs transition-colors border border-red-500/30"
          >
    ...
    <div className="flex h-screen w-screen bg-slate-950 text-slate-100 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col border-r border-slate-800 relative bg-black/20">
        ...
        <main className="flex-1 flex items-center justify-center p-8 bg-slate-950/40 relative">
          <div className="w-full max-w-5xl aspect-video rounded-2xl overflow-hidden bg-slate-900 shadow-2xl border border-slate-800/50 relative z-0">
            {isMounted && activeUrl ? (
              ...
              <div className={`max-w-[90%] rounded-2xl p-4 shadow-xl border ${msg.role === 'user'
                ...
                {msg.timestamp !== undefined && (
                  <div className="mt-4 pt-4 border-t border-slate-700/50">
                    ...
                    <p className="text-[10px] text-center mt-2 text-slate-500 opacity-60">Click above or use the inline links to seek</p>
                  </div>
                )}
              </div>
            </div>
